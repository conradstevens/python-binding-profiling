...
PYBIND11_MODULE(pybind11_bindings, m) {
    ...
    m.def("addition_three_times", &addition, "Pybind11 function that adds, divides and multiplies two floats");
    m.def("fibonacci", &fibonacci, "Pybind11 function that returns list of fibonacci numbers");
    m.def("fibonacci_numpy", &fibonacci, py::call_guard<py::gil_scoped_release>(), "Returns list of fibonacci numbers");
